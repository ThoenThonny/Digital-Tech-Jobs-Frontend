...
export default function JobDetail() {
  ...
  // Data processing functions - UPDATED FOR YOUR API STRUCTURE
  ...
  return (
    <div className="min-h-screen bg-gray-50 pt-16">
      {/* Header - REMOVED JOB ID AND BORDER LINE */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-xl shadow-sm border p-6 mb-6">
              <div className="flex flex-col sm:flex-row sm:items-start gap-4">
                <div className="flex-shrink-0">
                  <img
                    src={job.poster || '/default-job-image.jpg'}
                    alt={job.title}
                    className="w-56 h-46 rounded-lg object-cover "
                    onError={(e) => {
                      e.target.src = '/default-job-image.jpg';
                    }}
                  />
                </div>
                <div className="flex-1">
                  ...
                  <div className="flex flex-wrap items-center gap-4 text-gray-600 mb-3">
                    <div className="flex items-center gap-1">
                      <Building size={16} />
                      <span>{job.company || job.common}</span>
                    </div>
                    <div className="flex items-center gap-1">
                      <MapPin size={16} />
                  ...
                  <div className="grid  grid-cols-2 sm:grid-cols-4 gap-8 mt-4">
                    <div className="text-center p-3 bg-blue-50 rounded-lg">
                      <DollarSign className="mx-auto text-blue-600" size={20} />
                    ...
                    <div className="text-center p-3 bg-green-50 rounded-lg">
                      ...
                      <div className="mt-1 font-semibold">{job.experience}</div>
                      <div className="text-xs text-gray-500">Experience</div>
                    </div>
                    <div className="text-center p-3 bg-purple-50 rounded-lg">
                      <Clock className="mx-auto text-purple-600" size={20} />
                  ...
                  <button
                    ...
                    className={`flex items-center gap-2 px-6 py-4 border-b-2 font-medium whitespace-nowrap transition-colors ${
                      activeSection === section.id
                        ? 'border-blue-600 rounded-xl text-blue-600 bg-blue-50'
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-24 space-y-6">
              {/* Apply Card - REMOVED SAVE FOR LATER BUTTON */}
              <div className="bg-white rounded-xl shadow-sm border p-6">
                ...
                <button 
                  ...
                  onClick={() => {
                    console.log('Applying for job:', job.id || job.if);
              ...
              {/* Company Info */}
              <div className="bg-white rounded-xl shadow-sm border p-6">
                <h3 className="text-lg font-semibold text-gray-900 mb-4">About {job.company || job.common}</h3>
              ...
              <div className="bg-white rounded-xl shadow-sm border p-6">
                ...
                <div className="space-y-3 text-sm">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-gray-700">{job.category || 'IT'}</span>
                  </div>
                </div>
              </div>
            </div>

...
export default function AllMaketingCard() {
  const { id } = useParams();
                ...
                <div className="flex-1">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-8 mt-4">
                    <div className="text-center p-3 bg-green-50 rounded-lg">
                      <DollarSign className="mx-auto text-green-600" size={20} />
                      <div className="mt-1 font-semibold">{formatSalary(job.salary)}</div>
                      <div className="text-xs text-gray-500">Salary</div>
                    </div>
                    <div className="text-center p-3 bg-blue-50 rounded-lg">
                      <Briefcase className="mx-auto text-blue-600" size={20} />
                  ...
                  <button
                    ...
                    className={`flex items-center gap-2 px-6 py-4 border-b-2 font-medium whitespace-nowrap transition-colors ${
                      activeSection === section.id
                        ? 'border-green-600 rounded-xl text-green-600 bg-green-50'
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-24 space-y-6">
              ...
              <div className="bg-white rounded-xl shadow-sm border p-6">
                ...
                <button 
                  className="w-full bg-green-600 text-white py-3 px-6 rounded-lg hover:bg-green-700 transition duration-200 font-semibold shadow-sm"
                  onClick={() => {
              ...
              <div className="bg-white rounded-xl shadow-sm border p-6">
                ...
                <div className="space-y-3 text-sm">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-gray-700">{job.category || 'Marketing'}</span>
                  </div>
                  <div className="flex justify-between">

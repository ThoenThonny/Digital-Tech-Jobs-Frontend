...
import { jobsByLevel } from './Maketing';
...
export default function AllMaketingCard() {
  ...
  const job = jobsByLevel.find((item) => item.id === Number(id));
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Header */}
      <div className="w-full h-[100px] bg-blue-500 flex items-center justify-center text-white text-2xl font-bold">
        Job Details
      </div>
